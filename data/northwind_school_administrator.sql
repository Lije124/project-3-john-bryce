...
CREATE TABLE `school_administrator` (
  ...
  `administrator_e-mail` varchar(45) NOT NULL,
  `administrator_password` varchar(10) NOT NULL,
  PRIMARY KEY (`administrator_id`),
  CONSTRAINT `administrator_id` FOREIGN KEY (`administrator_id`) REFERENCES `school_adminroles` (`id_administrator`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2017-11-01 13:50:14
